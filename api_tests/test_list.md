# List of API tests for Tool Shop system

## `Users` module tests

Author: **Maksymilian Paluśkiewicz 247754**

### collection: `tool-shop-users-dev-tests`

| Test Set Name                              | Tests within the Set                                                                                                                      | Category                                |
| :----------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------- |
| `login`                                    | `Login successful`                                                                                                                        | _Setup & Authentication_                |
